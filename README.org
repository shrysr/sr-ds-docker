...
The starting point of this dockerfile is from [[https://github.com/business-science/shinyauth][Matt Dancho's shinyauth]] example file, which is generally referred to as the base template in this document. This repo will reflect my effort to construct a docker image to use with datascience projects, and thus take a step towards establishing a clear methodology for reproducible results in my work. The initial focus will be on R, and will slowly extend to including Python as well.

In this regard, the [[https://hub.docker.com/r/datascienceschool/rpython][Data Science School's docker image]] is quite useful as a comprehensive reference.
...
* Notes
/There are a bunch of general docker related notes and references [[https://shreyas.ragavan.co/docs/docker-notes/][on my website]]./
