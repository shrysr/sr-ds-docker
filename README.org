...
- One alternate method to read the documentation is via [[https://sr-ds-docker.readthedocs.io/en/latest/][readthedocs]]
#+END_QUOTE
...
* Notes
This is a collection of notes and lessons learned on different aspects of the project. [[https://shreyas.ragavan.co/docs/docker-notes/][My website]] contains some general docker related notes on various aspects and command references.
...
:PROPERTIES:
:header-args: :mkdirp yes :tangle ./rbase/r_custom_packages.R
