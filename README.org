...
The starting point of this project was [[https://github.com/business-science/shinyauth][Matt Dancho's shinyauth]] docker file, which then expanded into using the well designed [[https://github.com/matrixds/tools][Matrix DS tools]] for my purpose. Their docker stack of tools is replicated here with my customization.
...
This Readme consists of the entire documentation and source code in a single Org mode document.
...
* Notes
[[Https://shreyas.ragavan.co/docs/docker-notes/][My website]] contains some general docker related notes on various aspects and command references
...
2. [ ] Example for launching a temporary shiny server with 2 ports exposed for 2 processes, and specifying the location of the apps and the logs.
...
#+RESULTS:
: 165ae30412e0d670283d1df0cef5b7e7c4da3de998c87626a8125979e5b9785e
...
#+RESULTS:
: 4e0377a1c8e0817208a5c32eb8e2232d44e54aa4ae02442e2585bb9a1256771e
...
: 4e0377a1c8e0        shrysr/shiny:v2     "sh -c '/entrypoint.…"   2 seconds ago       Up 1 second         0.0.0.0:3838->3838/tcp   focused_panini
