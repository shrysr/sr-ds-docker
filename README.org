...
#+/bin/bash
docker container run -d --rm  -p 3838:3838 \
...
#+RESULTS:
: edf2734c5933cadd45c7bd83d9efccdf14544c3b734e67a0f28e0b8466e22bf1
...
# Installing libraries for  Linear Regression with GLMnet
RUN install2.r --error --deps TRUE \
	glmnet \
	parsnip \
	recipes \
...
# Adding Rstudio server preview version 1.2
...
USER root
ENV RSTUDIOSERVER_VERSION 1.2.5001
RUN \
